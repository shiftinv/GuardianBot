...
class _MultiBase(Generic[_TCmd, _TSlashCmd]):
    ...
    def create(
        ...
        *,
        ...
        _cls = cast(
            Type[_MultiBase[_TCmd, _TSlashCmd]], cls
        )  # typing generic classmethods and return types correctly is basically impossible
    ...
    def __set_name__(self, owner: Type[commands.Cog], name: str) -> None:
        ...
        assert issubclass(
            owner, BaseCog
        ), "multicmd may only be used in types derived from `BaseCog`"
